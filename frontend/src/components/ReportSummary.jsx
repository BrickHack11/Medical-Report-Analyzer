...
const ReportSummary = ({ fileUrl, fileType, analysisReport, fileName, onBack }) => {
    ...
    // Language options
    const languages = ["English", "Chinese", "Hindi", "Marathi","Spanish","French"];
    ...
    // Function to save translated summary to the database
    const saveSummary = async () => {
        ...
        const requestData = {
            ...
            file_name: fileName,
            analysis_report: translatedReport, // ✅ Save the translated report
        };
        ...
        try {
            ...
            alert(`Summary saved successfully in ${selectedLanguage}! ✅`);
